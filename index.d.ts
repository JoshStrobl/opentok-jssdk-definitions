declare module 'opentok' {
	...
	class OT {
		constructor();
		public checkScreenSharingCapability(callback: (options: OT.ScreenSharingCapability) => void): void;
		public checkSystemRequirements(): 0 | 1;
		public getDevices(callback: (error: Error | null, devices: OT.Device[]) => void): void;
		public initPublisher(targetElement: HTMLElement | string, properties: OT.PublisherProperties, completionHandler: (error: Error | null) => void): OT.Publisher;
		public initSession(apiKey: string, sessionId: string, options?: OT.InitOptions): OT.Session;
		public log(message: string): void;
		public off(type: string, handler: Function, context?: any): void;
		public on(type: string, handler: Function, context?: any): void;
		public once(type: string, handler: Function, context?: any): void;
		public registerScreenSharingExtension(kind: "chrome", id: string, version: number): void;
		public reportIssue(completionHandler: Function): void;
		public setLogLevel(level: number): void;
		public upgradeSystemRequirements(): void;
	}
}
